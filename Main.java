...
//
		//	 farmacia.adicionarProduto(new Produto("Bala", 2, 8, 100));
//
		//	 farmacia.adicionarTransportadora(new Transportadora("Sedex", 123, "Curitiba"));
		...
		do {
			...
			switch (op) {
				...
				case 13: {
					...
					System.out.printf("Lucro mensal do mês " + mes + " R$: %.2f%n", farmacia.calculaLucroMensal(mes));
				...
				case 14: {
					...
					int ano = input.nextInt();
					System.out.printf("Lucro anual do ano " + ano + " R$: %.2f%n", farmacia.calculaEstimativaLucroAnual(ano));
				...
				case 15: {
					...
					int mes = input.nextInt();
					System.out.printf(
							"Lucro mensal do mês " + mes + "R$: %.2f%n", farmacia.calculaEstimativaLucroMensal(mes));
				...
				case 18: {
					System.out.printf("Caixa atual da Empresa: %.2f%n", Servico.getCaixa());
					break;
				}
